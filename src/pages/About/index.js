...
import backgroundImage
    from '../Landing/[removal.ai]_eb8ebcc3-f3b9-432c-992d-e441ee26013a-candle-cupcake-happy-birthday-happy-birthday-wallpaper-preview-transformed.png'
    ...
    return <div className="About">
        ...
        <div className="About__content">
            ...
            <div className="About__layout">
                <div><p className="About__paragraph">
                    ...
                    <p className="About__paragraph">
                        Mozete nas kontaktirati pomocu broja telefona <a href="tel:+38112324234"
                                                                         className="AppLink">+38112324234</a> ili putem
                        mejla <a href="mailto:slatkomir@etf.bg.ac.rs" className="AppLink">slatkomir@etf.bg.ac.rs</a>.
                    </p></div>
                <div className="About__mapContainer"><img alt="noImg" className="About__map" src={mapImage}></img></div>
            </div>
        </div>
    </div>
}
